...
import pytest
from aws_cfn_resources_schemas import get_resource_schema, validate_resource_against_definition
...
def test_resource_schema_import():
    ...
    assert json.loads(get_resource_schema("AWS::ECS::Cluster", raw=True)) == schema_definition
